...
curl http://tinc-vpn.org/packages/tinc-1.1pre14.tar.gz | tar xzC /tmp && \
cd /tmp/tinc-1.1pre14 && ./configure --prefix=/usr --sysconfdir=/etc --localstatedir=/var && make && make install && \
